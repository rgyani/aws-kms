...
### KMS with EBS
1. You can not change the encryption key used by an EBS volume
...
2. It is Integration with Amazon RDS (MySQL, PostgreSQL, Aurora) and can be used to **automatically update the DB user credentials on rotation** 
